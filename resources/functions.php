...
function send_message() {
    ...
    if(isset($_POST['submit'])){ 
        ...
        if(!$result) {
            ...
            set_message("Error!! Your Message could not be sent");
            redirect("contact.php");
        } else {

            set_message("Success!! Your Message has been successfully sent");
            redirect("contact.php");
        }
...
return $category_row['categories_title'];
...
$categories_options = <<<DELIMETER
 ...
 <option value="{$row['categories_id']}">{$row['categories_title']}</option>
...
<tr>
    <td>{$categories_id}</td>
    <td>{$categories_title}</td>
    <td><a class="btn btn-danger" href="./index.php?delete_category_id={$row['categories_id']}"><span class="glyphicon glyphicon-remove"></span></a></td>
</tr>
...
$categories_title = escape_string($_POST['categories_title']);

if(empty($categories_title) || $categories_title == " ") {
...
$insert_cat = query("INSERT INTO categories(categories_title) VALUES('{$categories_title}') ");
confirm($insert_cat);
