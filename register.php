...
<head>
    ...
    <title>Registration Page - E-commerce</title>
...
<div class="container">
    ...
    <header>
        <h1 class="text-center">La-Boutique Registration Form</h1>
        <div class="col-sm-4 col-sm-offset-5">
            <form class="" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group"><label for="password">
                        Password<input type="text" name="password_1" class="form-control"></label>
                </div>
                <div class="form-group"><label for="password">
                        Confirm Password<input type="text" name="password_2" class="form-control"></label>
                </div>

                <div class="form-group">

                    <p style="font-size:18px; color:#020607">
                        Already have an account? <a href="login.php" style="color: #3c5adb;">Sign in</a>
                    </p>
